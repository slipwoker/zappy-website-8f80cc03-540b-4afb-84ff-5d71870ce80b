  ...
  if (animatedElements.length > 0) {
    ...
    function applyInitialStyles(el) {
      ...
      if (!el.style.transform) {
        ...
        const distance  = el.getAttribute('data-animate-distance') || '30px';
        const transforms = {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8f80cc03-540b-4afb-84ff-5d71870ce80b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8f80cc03-540b-4afb-84ff-5d71870ce80b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8f80cc03-540b-4afb-84ff-5d71870ce80b';
